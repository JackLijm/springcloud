...
@Component
public class SpringDirectSender {
    ...
    public void sendMessage(MessageDTO messageDTO) {
        ...
        rabbitTemplate.convertAndSend(RabbitMqConstant.DIRECT_EXCHANGE_NAME, RabbitMqConstant.DIRECT_MESSAGE_ROUTING_KEY_NAME, content);
    }
    ...
    public void sendEmail(EmailDTO emailDTO) {
        ...
        rabbitTemplate.convertAndSend(RabbitMqConstant.DIRECT_EXCHANGE_NAME, RabbitMqConstant.DIRECT_EMAIL_ROUTING_KEY_NAME, content);
    }
}
